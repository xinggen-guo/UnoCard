...
@NonNullApi
public class UnoCardProjectDependency extends DelegatingProjectDependency {

    @Inject
    public UnoCardProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
